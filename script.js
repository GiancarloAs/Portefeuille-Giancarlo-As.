...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function openLightbox(item) {
        ...
        // Respecte le format d'origine de chaque image : si la miniature
        // porte un aspect-ratio inline (cas des posts au format variable,
        // ex. OLMOS), on l'applique aussi au lightbox. Sinon on revient au
        // ratio 1080x1350 par défaut défini dans le CSS.
        const customRatio = mediaEl ? mediaEl.style.aspectRatio : '';
        lightboxMedia.style.aspectRatio = customRatio || '';
